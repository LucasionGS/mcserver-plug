...
(function (Api) {
    ...
    function downloadServer(release, location) {
        return __awaiter(this, void 0, void 0, function* () {
            release = yield release;
            let p = IonUtil_1.default.promise();
            fs.mkdirSync(location, { recursive: true });
            let dl = new ionew_1.Network.Download(release.downloads.server.url, location + "/server.jar");
            return dl;
        });
    }
